...
// Forms
	...
	$('#form3').jqTransform({imgPath:'images/'});    /********* - my - ********/
	$('#form4').jqTransform({imgPath:'images/'});    /********* - my - ********/
	$('#form5').jqTransform({imgPath:'images/'});    /********* - my - ********/
	$('#form6').jqTransform({imgPath:'images/'});    /********* - my - ********/
	$('#form7').jqTransform({imgPath:'images/'});    /********* - my - ********/
	$('#form8').jqTransform({imgPath:'images/'});    /********* - my - ********/
	$('#form9').jqTransform({imgPath:'images/'});    /********* - my - ********/
	$('#form10').jqTransform({imgPath:'images/'});    /********* - my - ********/
// Carausel
	$('.list-car').uCarausel({show:4,buttonClass:'car-button'})
	$('.carousel').uCarausel({show:4,buttonClass:'car-button'})
	$('.carousel-2').uCarausel({show:6,buttonClass:'car-button'}) /********-my-********/
	$('.carousel-3').uCarausel({show:4,buttonClass:'car-button'}) /********-my-********/
// Slider
	$('.slider')._TMS({
		show:0,
		pauseOnHover:false,
...
// My Gallery
	$('.gallery')._TMS({
			...
			duration:1000,
			preset:'zabor',
			pagination:$('.img-pags2').uCarausel({show:5,shift:0,buttonClass:'btn2',axis:'y'}),
			pagNums:false,
			slideshow:5000,
			numStatus:false,
			pauseOnHover:true,
